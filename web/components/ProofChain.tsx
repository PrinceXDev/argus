              ...
              >
                ...
                <div className="mt-2.5 flex flex-wrap items-center gap-x-3 gap-y-1.5 text-[11px] text-muted">
                  {isRoot ? (
                    ...
                    <span className="font-mono">
                      step {(step.confidence * 100).toFixed(0)}% · w={step.weight}
                    </span>
                  )}
                ...
                {disputed.map((d, j) => (
                  ...
                  >
                    ...
                    <span className="text-muted"> by {d.counterSource.name}: </span>
                ...
                {onRetract && (
                  ...
                  >
                    {retractingId === step.claimId ? 'retracting…' : 'retract this fact'}
                  </button>
                )}
              </div>
            </div>
